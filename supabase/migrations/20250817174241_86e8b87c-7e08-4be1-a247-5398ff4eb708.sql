-- Fix loan disbursement date field validation trigger
-- Update the validate_loan_client_date function to use correct field names
...
BEGIN
  ...
  v_date_text := COALESCE(
    v_payload->>'disbursement_date',  -- Fixed: use disbursement_date instead of disbursed_on_date
