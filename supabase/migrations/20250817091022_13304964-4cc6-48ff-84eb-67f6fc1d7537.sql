-- Fix the calculate_account_balance_with_periods function
DROP FUNCTION IF EXISTS calculate_account_balance_with_periods(uuid, date, date);
...
RETURNS TABLE(opening_balance numeric, period_debits numeric, period_credits numeric, closing_balance numeric)
LANGUAGE plpgsql
SECURITY DEFINER
