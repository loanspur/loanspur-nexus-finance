...
export const LoanProductFeesTab = ({ form, tenantId }: LoanProductFeesTabProps) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Built-in Fees</CardTitle>
          <CardDescription>
            Configure basic processing fees and penalties that are built into the loan product
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Early Repayment Penalty (%)</FormLabel>
                  <FormControl>
                    <Input
                      type="number"
                      step="0.01"
